...
public class DuplicatesTest {
    ...
    public void findDuplicates() {
        ...
        assertEquals(Arrays.asList(3), new Duplicates().find(Arrays.asList(1, 2, 3, 3, 3, 4)));
        assertEquals(Arrays.asList(2, 3), new Duplicates().find(Arrays.asList(1, 2, 2, 3, 3, 3, 4)));
    }
}
